...
from funciones import developer, user_data, UserForGenre, best_developer_year, desarrollador_reviews_analysis, recomendacion_juego, recomendacion_usuario
import pandas as pd
import numpy as np
...
def usergenre(genero: str):
    funcion_tres = UserForGenre(genero)
    return funcion_tres 
